...
class Nota {
    ...
    conceito() {
        if(this.nota === 0){
            return "E";
        } else if(this.nota >= 1 && this.nota <= 35){
            return "D";
        } else if(this.nota >= 36 && this.nota <= 60){
            return "C";
        } else if(this.nota >= 61 && this.nota <= 85){
            return "B";
        } else {
            return "A";
        }
...
const resposta = new Nota(lines[0]);
console.log(resposta.conceito());
