...
'''
tempoGastoNaViagem = int(input())
velocidadeMedia = int(input())
consumoDoCarroPorLitros = 12

quilometragemTotal = velocidadeMedia * tempoGastoNaViagem

litrosGasolinaTotal = quilometragemTotal / consumoDoCarroPorLitros

print(f'{litrosGasolinaTotal:.3f}')
